...
export default function Footer() {
    return(
        <footer className="pv4 ph3 ph5--m ph6-l mid-gray tc">
            ...
            <svg class="dib h2 w2" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" fill-rule="evenodd" clip-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="1.414">
